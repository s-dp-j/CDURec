...
Cross-Domain and cross-User collaborative filtering **Recommendation** for
inactive users, by transferring the preference-mapping relationship of active
users.

## Model overview

CDURec runs a five-step pipeline (Algorithm 2):
